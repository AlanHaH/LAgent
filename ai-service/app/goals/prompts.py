GOAL_RECOMMENDATION_PROMPT_VERSION = "goal-recommendation-v1"
...
3. 每个候选目标必须包含 directionId、name、type、description、priority、durationDays、
weeklyBudgetMinutes、successCriteria、reason、milestones。
4. directionId 只能选自输入 directions 中非空的 id；不得创造目录方向。
